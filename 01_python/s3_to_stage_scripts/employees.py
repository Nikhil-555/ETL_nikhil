...
#query to copy data 
query = f"""
COPY nikhil_db.devstage.employees (employeeNumber, lastName, firstName, extension, email, officeCode, reportsTo, jobTitle)
...
try:
    cursor.execute('truncate devstage.employees;')
